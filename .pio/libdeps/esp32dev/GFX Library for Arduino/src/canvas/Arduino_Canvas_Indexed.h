...
public:
  ...
  virtual void writeFastVLineCore(int16_t x, int16_t y, int16_t h, uint8_t idx);
  void writeFastHLine(int16_t x, int16_t y, int16_t w, uint16_t color) override;
  virtual void writeFastHLineCore(int16_t x, int16_t y, int16_t w, uint8_t idx);
  virtual void writeFillRectPreclipped(int16_t x, int16_t y, int16_t w, int16_t h, uint16_t color) override;
