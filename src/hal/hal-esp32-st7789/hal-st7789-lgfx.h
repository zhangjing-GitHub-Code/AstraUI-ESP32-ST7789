...
#define GFX_BL 25
#define I16 (uint16_t)
#define U8toLV static const lgfx::U8g2font
U8toLV chargen92(u8g2_font_chargen_92_tf);
U8toLV unifontCN(u8g2_font_unifont_t_chinese3);
#define LOG_FONT chargen92
